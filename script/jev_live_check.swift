...
struct JevLiveCheck {
    ...
    private static let scenarios: [Scenario] = [
        ...
        .init("review-click-input-zh", "点击输入按钮", intent: .clickElement, target: editor),
        .init("review-click-enter-en", "Click the Enter button", intent: .clickElement, target: editor),
        .init("review-click-input-described", "点击那个输入框", intent: .clickElement, target: editor),
        .init("review-click-enter-described", "Click the green Enter button", intent: .clickElement, target: editor),
        .init("review-reject-type-return", "输入 hello 然后回车"),
        .init("review-reject-type-newline", "输入 hello 然后换行"),
        .init("review-literal-return", "输入「hello 然后回车」", intent: .typeText, target: editor, text: "hello 然后回车"),
        .init("review-literal-click", "输入「点击输入按钮」", intent: .typeText, target: editor, text: "点击输入按钮"),
